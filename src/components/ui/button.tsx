...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent text-accent-foreground shadow-[0_6px_18px_rgb(20_67_60_/_0.22)] hover:-translate-y-0.5",
        outline: "glass-soft hover:bg-muted/70",
        ghost: "hover:bg-muted/75",
        secondary: "glass-soft text-foreground hover:bg-muted/75",
      },
      size: {
